        ...
        <div class="container">
            <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="d-flex flex-wrap align-items-center mt-4 mt-lg-0">
                                    ...
                                    <div>
                                        <a href="<?php echo e(route('job-listings')); ?>" class="badge">Web design</a>
                                        <a href="<?php echo e(route('job-listings')); ?>" class="badge">Marketing</a>
                                        <a href="<?php echo e(route('job-listings')); ?>" class="badge">Customer support</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-6 col-12">
                    <img src="<?php echo e(asset('images/4557388.png')); ?>" class="hero-image img-fluid" alt="Job Search">
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="job-thumb job-thumb-box">
                        <div class="job-image-box-wrap">
                            <a href="<?php echo e(route('job-details', $job->id)); ?>">
                                <img src="<?php echo e(asset($job->image)); ?>" class="job-image img-fluid" alt="<?php echo e($job->title); ?>">
                            </a>
                            <div class="job-image-box-wrap-info d-flex align-items-center">
                                <p class="mb-0">
                                    <a href="<?php echo e(route('job-listings')); ?>" class="badge badge-level"><?php echo e($job->level); ?></a>
                                </p>
                                <p class="mb-0">
                                    <a href="<?php echo e(route('job-listings')); ?>" class="badge"><?php echo e($job->type); ?></a>
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="job-body">
                            <h4 class="job-title">
                                <a href="<?php echo e(route('job-details', $job->id)); ?>" class="job-title-link"><?php echo e($job->title); ?></a>
                            </h4>
                            <div class="d-flex align-items-center">
                                <div class="job-image-wrap d-flex align-items-center bg-white shadow-lg mt-2 mb-4">
                                    <img src="<?php echo e(asset($job->company->logo)); ?>" class="job-image me-3 img-fluid" alt="<?php echo e($job->company->name); ?>">
                                    <p class="mb-0"><?php echo e($job->company->name); ?></p>
                                </div>
                            ...
                            <div class="d-flex align-items-center border-top pt-3">
                                ...
                                <a href="<?php echo e(route('job-details', $job->id)); ?>" class="custom-btn btn ms-auto">Apply now</a>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/behruz/Рабочий стол/laravel-job-aplication-main/resources/views/job-listings.blade.php ENDPATH**/ ?>